        ...
        <div id="comments" className="mt-4">
          <div>
            ...
            {!inPostDetail
              ...
              <div className="pt-10">
                <div className="text-center border-t dark:border-white dark:md:border-opacity-10 dark:border-opacity-[0.05] dark:text-white text-black text-opacity-80 tracking-widest border-gray-f2 pt-3 bg-white dark:bg-[#181818] cursor-pointer flex items-center justify-center absolute bottom-3 left-0 w-full" onClick={() => {
