    ...
    <Fade in={true} timeout={350}>          
      <div
        className={classNames({
          'border-b dark:border-white dark:md:border-opacity-10 dark:border-opacity-[0.05] border-gray-ec border-opacity-70': (isMobile && !inPostDetail) || (isPc && props.withBorder),
